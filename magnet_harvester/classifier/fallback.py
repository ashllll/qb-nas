...
LOCAL_RULES: List[Tuple[str, str]] = [
    ...
    # ── 电影 ──
    (r'\bblu-?ray\b|\bbdremux\b|\bremux\b|\bbdrip\b|\bbrrip\b|\bdvdrip\b|\bdvd-?r\b|\bhddvd\b|\bhdrip\b', "电影"),
    (r'电影|movie\b|filme?\b|片源|枪版|tc版|ts版|cam\b|hd-?tc', "电影"),
    (r'\b(19|20)\d{2}\b.*\b(blu-?ray|web-?dl|bdrip|brrip|x26[45]|hevc|avc|hdr)\b', "电影"),
    (r'\b(fgt|rarbg|yify|yts|cmrg|tigole|qxr|utr|hon3y|sartre|evo|galaxyrg|ntb|playnow|megusta|qman|nosliv)\b', "电影"),
